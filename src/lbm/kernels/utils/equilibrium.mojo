...
@always_inline
def get_f_eq_vec[float_dtype:DType,int_dtype:DType,D:Int,Q:Int,//,DDF_shift:Bool,](
...
def get_f_noneq_vec[
    ...
    *,
    ...
    """
    var f_neq = f_vec - get_f_eq_vec[DDF_shift](f_vec,density,velocity, directions,weights) 
