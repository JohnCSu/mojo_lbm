...
def calculate_vorticity[
    ...
    D:Int,
    *,
    N:Int = 1 if D == 2 else 3 # Do not modify
    ]
    (
...
def calculate_Q_criterion[
    ...
    *,
    ...
    comptime stress_indices = materialize[lattice.stress_indices]()
    ...
    if index[0] < grid_shape[0] and index[1] < grid_shape[1] and index[2] < grid_shape[2] and flag != SOLID_NODE: # Basic Guard
        ...
        var f_neq = get_f_noneq_vec[config.DDF_shift](f_vec,rho,u,tau, directions,weights)
