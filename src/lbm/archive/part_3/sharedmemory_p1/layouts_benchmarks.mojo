...
def benchmark_func_col_tile_row_tiler[
    ...
    *,
    ...
    comptime all_slice = slice(None,None,None)
    comptime simd_width = 4
    comptime flag_tile = col_major[grid.layouts.x_tile,grid.layouts.y_tile,1]()
    comptime f_tile = col_major[grid.layouts.x_tile,grid.layouts.y_tile,1,Q]()
    comptime bc_tile = col_major[grid.layouts.x_tile,grid.layouts.y_tile,1,D+1]()
...
def benchmark_func_row_tile_row_tiler[
    ...
    *,
    ...
    comptime all_slice = slice(None,None,None)
    comptime simd_width = 4
    comptime flag_tile = row_major[grid.layouts.x_tile,grid.layouts.y_tile,1]()
    comptime f_tile = row_major[grid.layouts.x_tile,grid.layouts.y_tile,1,Q]()
    comptime bc_tile = row_major[grid.layouts.x_tile,grid.layouts.y_tile,1,D+1]()
